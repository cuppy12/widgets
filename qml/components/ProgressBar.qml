...
Item {
    ...
    readonly property color fillColor: status === ProgressBar.Success
                                      ? successColor
                                      : (status === ProgressBar.Warning
                                         ? warningColor
                                         : (status === ProgressBar.Error ? errorColor : progressColor))
