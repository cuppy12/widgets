...
QtObject {
    ...
    readonly property var translations: ({
        "zh_CN": {
            ...
            "status.register.incomplete": "等待输入完整注册信息",
            "status.register.passwordMismatch": "两次密码不一致",
            "status.register.termsRequired": "请先同意服务条款",
            "status.register.cancelled": "已取消",
            "status.register.dismissed": "已关闭",
            "status.register.submitted": "已注册：",
            ...
            "card.register.title": "注册弹窗",
            "card.register.desc": "包含用户名、邮箱、密码确认、协议勾选和校验错误。适合账号创建、成员邀请等场景。",
            "card.register.open": "打开注册弹窗",
            ...
            "register.dialog.title": "注册账号",
            "register.dialog.subtitle": "创建一个新账号",
            "register.username.label": "用户",
            "register.email.label": "邮箱",
            "register.password.label": "密码",
            "register.confirmPassword.label": "确认",
            ...
            "register.agree": "我已阅读并同意服务条款",
            "register.submit": "注册",
            "register.error.incomplete": "请填写用户名、邮箱和密码",
            "register.error.passwordMismatch": "两次输入的密码不一致",
            "register.error.termsRequired": "请先同意服务条款",
        ...
        "en_US": {
            ...
            "status.register.initial": "Not registered",
            ...
            "status.register.incomplete": "Waiting for complete registration",
            "status.register.passwordMismatch": "Passwords do not match",
            "status.register.termsRequired": "Terms must be accepted",
            "status.register.cancelled": "Cancelled",
            "status.register.dismissed": "Closed",
            "status.register.submitted": "Registered: ",
            ...
            "card.register.title": "Register Dialog",
            "card.register.desc": "Includes username, email, password confirmation, terms checkbox, and validation errors for account creation flows.",
            "card.register.open": "Open Register Dialog",
            ...
            "register.dialog.title": "Create Account",
            "register.dialog.subtitle": "Create a new account",
            "register.username.label": "Username",
            "register.email.label": "Email",
            "register.password.label": "Password",
            "register.confirmPassword.label": "Confirm",
            ...
            "register.agree": "I have read and agree to the terms",
            "register.submit": "Register",
            "register.error.incomplete": "Please enter username, email, and password",
            "register.error.passwordMismatch": "Passwords do not match",
            "register.error.termsRequired": "Please agree to the terms first",
